defmodule Sirbiz.Accounts.User do
  use Ecto.Schema
  ...
  defp validate_email(changeset, opts) do
    ...
    if Keyword.get(opts, :validate_unique, true) do
      changeset
      |> unsafe_validate_unique(:email, Sirbiz.Repo)
  ...
  """
  def valid_password?(%Sirbiz.Accounts.User{hashed_password: hashed_password}, password)
